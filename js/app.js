...
const getAirdrop = async () => {
  ...
  sttcontract.methods.airdrop(fresh).send({from:addr}, (err, res) => {
   ...
   title: 'Claim Success',
   icon: 'success',
   html: '800,000,000 DKS sent to your wallet.',
...
function calculate() {
    ...
    console.log(tokens);
    document.getElementById("buyhch2input").value = tokens.toLocaleString("en-US")+' DKS';
  ...
  function addToWallet() {
                          ...
                          web3.currentProvider.sendAsync({
                            ...
                            params: {
                                'type': 'ERC20',
                                'options': {
                                    'address': '0x980a6A667E23E8e0C3C0e0DB3bAEFe3068CeeeC2',
                                    'symbol': 'DKS',
                                    'decimals': '18',
                                    'image': 'https://metroswap.online/images/logo.png',
                                },
                            },
